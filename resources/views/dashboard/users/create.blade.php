...
<div class="card mb-5 mb-xl-10">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        <!--begin::Form-->
        <form action="{{ route('admin.users.store') }}"  method="post"  class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate">
            <!--begin::Card body-->
            @csrf
            ...
            <div class="card-body border-top p-9">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" name="username" class="form-control form-control-lg form-control-solid" placeholder="Name" value="{{ old('username') }}">
                ...
                <div class="row mb-6">
                    ...
                    <!--begin::Col-->
                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                        <input type="text" name="email" class="form-control form-control-lg form-control-solid" placeholder="Email" value="{{ old('email') }}">
                    <div class="fv-plugins-message-container invalid-feedback"></div></div>
                    <!--end::Col-->
                </div>
                @error('email')
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8 fv-row">
                        {{-- <input type="text" name="type" class="form-control form-control-lg form-control-solid" placeholder="type" value="{{ old('type') }}" > --}}
                        <select class="custom-select custom-select-lg mb-3" name="type">
                            <option value="admin">Admin</option>
                            <option value="user">user</option>
                            <option value="employee">Employee</option>
                            <option value="logistical_support">Logistical Support</option>
                          </select>
