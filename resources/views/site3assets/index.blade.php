...
@section('content')
    ...
    <section class="slider_section ">
        <div class="play_btn">
            <a href="">
                <img src="{{ asset('site3assets/images/play.png') }}" alt="">
            </a>
        </div>
    ...
    <section class="discount_section  layout_padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="img-box">
                        <img src="{{ asset('site3assets/images/discount-img.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="client_container layout_padding2">
                <div class="client_box b-1">
                    <div class="client-id">
                        <div class="img-box">
                            <img src="{{ asset('site3assets/images/client-1.png') }}" alt="" />
                        </div>
                        <div class="name">
                            <h5>
                                Magna
                ...
                <div class="client_box b-2">
                    <div class="client-id">
                        <div class="img-box">
                            <img src="{{ asset('site3assets/images/client-2.png') }}" alt="" />
                        </div>
                        <div class="name">
                            <h5>
                                Aliqua
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="info_contact">
                        ...
                        <div>
                            <div class="img-box">
                                <img src="{{ asset('site3assets/images/location-white.png') }}" width="18px"
                                    alt="">
                            </div>
                            <p>
                                Address
                        ...
                        <div>
                            <div class="img-box">
                                <img src="{{ asset('site3assets/images/telephone-white.png') }}" width="12px"
                                    alt="">
                            </div>
                            <p>
                                +01 1234567890
                        ...
                        <div>
                            <div class="img-box">
                                <img src="{{ asset('site3assets/images/envelope-white.png') }}" width="18px"
                                    alt="">
                            </div>
                            <p>
                                demo@gmail.com
